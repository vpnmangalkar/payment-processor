 ...
 * Class to Generate PayId for PaymentInitiation
 *  
 */
public class PaymentInitiationIdGenerator implements IdentifierGenerator {
			...
			private int getSequence(SharedSessionContractImplementor session) throws SQLException {
				...
				ResultSet rs = statement.executeQuery( " select nextval ('pay_initiation_id_sequence') ");
